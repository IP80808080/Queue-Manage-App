    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dateFormat.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(D16.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
        ...
        btn2Booked.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(D16.this,PaymentActivity.class);
